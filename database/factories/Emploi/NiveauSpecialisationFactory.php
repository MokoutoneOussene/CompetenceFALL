...
class NiveauSpecialisationFactory extends Factory
{
    protected $model = NiveauSpecialisation::class;
    ...
    public function definition()
    {
        ...
        $niveauSpecialisation = $this->faker->randomElement($niveauxSpecialisations);

        return [
            'intitule' => $niveauSpecialisation['intitule'],
            'niveau' => (int) $niveauSpecialisation['niveau'],
            'abreviation' => (int) $niveauSpecialisation['abreviation'],
            'description' => $niveauSpecialisation['description'],
        ];
    }
}
