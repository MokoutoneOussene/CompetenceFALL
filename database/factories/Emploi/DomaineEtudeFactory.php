...
class DomaineEtudeFactory extends Factory
{
    protected $model = DomaineEtude::class;
    ...
    public function definition()
    {
        ...
        $domaineEtude = $this->faker->randomElement($domainesEtudes);

        return [
            'intitule' => ucfirst($domaineEtude['intitule']),
            'description' => ucfirst($domaineEtude['description']),
        ];
    }
}
