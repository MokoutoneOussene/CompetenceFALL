...
return [
    ...
    'custom' => [
        'boitePostale' => [
            'regex' => 'Le format de la boîte postale n\'est pas valide. Utilisez le format \'## BP #### #### Ville, Pays\' avec des noms deville et de pays conformes ne contenant que des lettres, chiffres, tirets et traits de soulignement. Les \'#\' correspondent à des chiffres.Expression régulière: \'/^\\d{2} BP \\d{4} \\d{5} [\\p{L}\\s\\-]+,\\s+[\\p{L}\\s\\-]+$/u\'',
        ],
        'motDePasse' => [
            'regex' => 'Le mot de passe doit contenir au moins une lettre majuscule, une lettre minuscule et un chiffre.',
        ],
        'telephone' => [
            'regex' => 'L\'attribut telephone ne doit contenir que des chiffres',
        ],
    ],
];
